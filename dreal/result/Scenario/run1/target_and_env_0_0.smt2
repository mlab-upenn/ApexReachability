...
(define-ode flow_1 ((= d/dt[tau] 1) (= d/dt[Beta] (- (+ (* (- (/ (- (* 108000 1.515) (* 108000 1.292)) (* (* 2273 v) v)) 1) Psi_dot) (/ (* 108000 delta) (* 2273 v))) (* (/ (+ 108000 108000) (* 2273 v)) Beta))) (= d/dt[Psi_dot] (+ (- (* (/ (- (* 108000 1.515) (* 108000 1.292)) 4423) Beta) (* (/ (+ (* (* 108000 1.292) 1.292) (* (* 108000 1.515) 1.515)) 4423) (/ Psi_dot v))) (* (/ (* 108000 1.292) 4423) delta))) (= d/dt[Psi] Psi_dot) (= d/dt[v] (+ (* 1 (+ (* (cos Psi_d) (- sx_d sx)) (* (sin Psi_d) (- sy_d sy)))) (* 10 (- 7.5 v)))) (= d/dt[sx] (* v (cos (+ Beta Psi)))) (= d/dt[sy] (* v (sin (+ Beta Psi)))) (= d/dt[delta] (- (+ (+ (* 2 (- (* (cos Psi_d) (- sy_d sy)) (* (sin Psi_d) (- sx_d sx)))) (* 12 (- Psi_d Psi))) (* 4 (- (- 0 (* (* 6 tau) (^ (/ (/ 1 (+ (* 9 (* (* (* tau tau) tau) tau)) 1)) (^ (+ (* 9 (* (* (* tau tau) tau) tau)) 1) 0.5)) 0.5))) Psi_dot))) (* 2 delta))) (= d/dt[sx_d] (* (* 7.5 3) (^ tau 2))) (= d/dt[sy_d] (* 7.5 -1)) (= d/dt[Psi_d] (- 0 (* (* 6 tau) (^ (/ (/ 1 (+ (* 9 (* (* (* tau tau) tau) tau)) 1)) (^ (+ (* 9 (* (* (* tau tau) tau) tau)) 1) 0.5)) 0.5)))) (= d/dt[Psi_ddot] (/ (* 6 (- (* 27 (* (* (* tau tau) tau) tau)) 1)) (^ (+ (* 9 (* (* (* tau tau) tau) tau)) 1) 2))) (= d/dt[sx_env] v_env) (= d/dt[v_env] 0)))
(assert (<= 0 v_env_0_0))
(assert (<= v_env_0_0 10))
(assert (<= 0 v_env_0_t))
(assert (<= v_env_0_t 10))
